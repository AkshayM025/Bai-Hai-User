                    ...
                    public void Success(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("1")) {
                                ...
                                //   https://bai-hai.com/webservice/get_profile?user_id=101
                                ...
                                if (result != null) {
                                    ...
                                    if (result2 != null) {
                                        rewardPoints = "Bye-Hi is in process of approving the product your coins are " + rewardPoints +
                                                " and you need " + result.optString("min_coin") + "coins  to next award";
                                    } else {
                                        rewardPoints = "Bye-Hi is in process of approving the product your coins are " + rewardPoints +
                                                " and you have all gifts. congratulations";
