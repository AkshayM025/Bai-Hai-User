...
public class AcceptedChatAdapter extends RecyclerView.Adapter<AcceptedChatAdapter.ViewHolder> {
    ...
    public AcceptedChatAdapter(Context context, List availableChatModal) {
    ...
    @NonNull
    @Override
    public AcceptedChatAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_available_chat, parent,
                false);
        AcceptedChatAdapter.ViewHolder viewHolder = new AcceptedChatAdapter.ViewHolder(v);
        return viewHolder;
    }


    @Override
    public void onBindViewHolder(@NonNull AcceptedChatAdapter.ViewHolder holder, int position) {
        ...
        holder.acceptedChat_CardId.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public CardView acceptedChat_CardId;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            acceptedChat_CardId = itemView.findViewById(R.id.availableChat_CardId);
